...
Units, `chanlocs`, padding, extra channels, attended/unattended pairing, empty trials, and whether one-Raw-per-trial is what MNE would want. Listed in [questions-for-maintainers.md](../questions-for-maintainers.md).
